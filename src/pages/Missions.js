    ...
    <table>
      ...
      <tr>
        ...
        <td className={styles.description}>
          ...
          commercial communication satellite ever launched, weighing at 7,076
          kg (15,600 lbs) and surpassing the previous record, set by TerreStar-1
          (6,910 kg/15,239 lbs), launched by Ariane 5ECA on 1 July 2009.
        </td>
        <td>
          <button type="button">Not a member</button>
        </td>
      ...
      <tr>
        ...
        <td className={styles.description}>
          ...
          by NASA from 2008-2006 for delivery of cargo and supplies to the
          ...
          to Space for 12 cargo transport missions and $1.9 billion to Orbital
          Sciences for 8 missions, covering deliveries in 2016. In 2025, NASA
